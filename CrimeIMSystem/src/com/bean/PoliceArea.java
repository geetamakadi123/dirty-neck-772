...
public class PoliceArea {
		...
		public String toString() {
			return "PoliceArea [StationId=" + StationId + ", PoliceStation_Name=" + PoliceStation_Name
					+ ", PoliceStation_Area=" + PoliceStation_Area + "]";
		}

		public PoliceArea(int stationId, String policeStation_Name, String policeStation_Area) {
			super();
			StationId = stationId;
			PoliceStation_Name = policeStation_Name;
			PoliceStation_Area = policeStation_Area;
