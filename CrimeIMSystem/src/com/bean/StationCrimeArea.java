...
public class StationCrimeArea {
		...
		public StationCrimeArea(int suspects_Id, String suspects_Name, String policeStation_Name, String policeStation_Area) {
			super();
			Suspects_Id = suspects_Id;
			Suspects_Name = suspects_Name;
			PoliceStation_Name = policeStation_Name;
