...
public class VictimProof {
		...
		public String toString() {
			return "VictimProof [Victims_Id=" + Victims_Id + ", Victims_Name=" + Victims_Name + ", PoliceStation_Name="
					+ PoliceStation_Name + ", PoliceStation_Area=" + PoliceStation_Area + "]";
		}

		public VictimProof(int victims_Id, String victims_Name, String policeStation_Name, String policeStation_Area) {
			super();
			Victims_Id = victims_Id;
			Victims_Name = victims_Name;
			PoliceStation_Name = policeStation_Name;
